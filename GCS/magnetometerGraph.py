...
class MagnetometerGraph:
    def __init__(self):
        ...
        self.curve_r = self.plot.plot(pen=pg.mkPen(color='r', width=3), name="MAG_R", symbol='o', symbolSize=8, symbolBrush='r')
        self.curve_p = self.plot.plot(pen=pg.mkPen(color='#1e8d12', width=3), name="MAG_P", symbol='o', symbolSize=8, symbolBrush='#1e8d12')
        self.curve_y = self.plot.plot(pen=pg.mkPen(color='b', width=3), name="MAG_Y", symbol='o', symbolSize=8, symbolBrush='b')
    ...
    def toggle_dark_mode(self, dark_mode: bool):
        ...
        # Update title color
        self.plot.setTitle("<b>Magnetometer</b>", color=title_color, size="12pt")
